...
<!--- contact/confirm.php/inline-style.css --->
<style>
  .form{
    padding: 2rem;
    width: 100%;
...
<form name="contactform" role="form" method="post" action="">
  <div class="form confirm">
    <div class="form-item">
      <div class="form-label"><p>御社名</p></div>
      <div class="form-content"><?php echo $contact_data['company_name']; ?></div>
    </div>
    <div class="form-item">
      <div class="form-label"><p>ご担当者名</p></div>
      <div class="form-content"><?php echo $contact_data['name']; ?></div>
    </div>
    <div class="form-item">
      <div class="form-label"><p>メールアドレス</p></div>
      <div class="form-content"><?php echo $contact_data['email']; ?></div>
    </div>
    <div class="form-item">
      <div class="form-label"><p>電話番号</p></div>
      <div class="form-content left"><?php echo $contact_data['tel']; ?></div>
    </div>
    <div class="form-item textarea">
      <div class="form-label textarea"><p>詳しく聞きたいこと</p></div>
      <div class="form-content textarea">
        <?php echo nl2br($contact_data['note']); ?>
      </div>
    </div>
  </div>
    <div class="form-button">
        <button class="button button-blue button-large" type="submit">送信する<i class="icon-arrow-right"></i></button>
    </div>
