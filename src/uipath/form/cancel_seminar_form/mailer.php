...
$email->addTo($emailAdress)->
       ...
       setHtml("$company <br> $lastname $firstname 様<br><br>ご連絡いただきまして、ありがとうございます。<br>下記内容でお申し込みのキャンセルを承りました。<br><br>会社名: $company <br />ご希望の開催日： $seminar <br />メールアドレス: $emailAdress <br />電話番号: $phone <br />特記事項: $message <br />個人情報の取扱: $check <br /><br>別日程でのご参加をご希望の方は<br> https://www.iimhs.co.jp/uipath/form/seminar_form/ よりお申し込みください。<br><br>")->
       addCategory('contact');
...
header('Location: /uipath/form/cancel_seminar_form/thanks.html');
exit();
