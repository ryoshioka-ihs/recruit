...
$email->addTo($emailAdress)->
       ...
       setSubject("【xoBlosセミナーへお申込みいただきましてありがとうございます】" )->
       setText("
       	$company \r\n
       	$name1 $name2 様\r\n\r\n

       	この度は弊社『xoBlosセミナー』へお申込みいただきまして、誠にありがとうございます。\r\n
       	下記内容でお申し込みを承りました。\r\n\r\n　
       	＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\r\n　
       	会社名: $company \r\n 
       	ご希望の開催日: $seminar \r\n 
       	...
       	・お名刺\r\n\r\n
       	★キャンセルについて\r\n
       	お電話（03-5684-6840）にて承っております。")->


       setHtml("
       	$company <br> 
       	$name1 $name2 様<br><br>
       	この度は弊社『xoBlosセミナー』へお申込みいただきまして、誠にありがとうございます。<br>
       	下記内容でお申し込みを承りました。<br><br>
       	＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝<br>
       	会社名: $company <br />
       	ご希望の開催日： $seminar <br />
       	部署名: $despartment <br />
       	...
       	本セミナーに参加され、どのようなことが知りたいですか？: $message <br />
       	個人情報の取扱: $check <br />
       	＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝<br>
       	★当日のお持ちものについて<br>
       	・お名刺<br><br>
...
$email->addTo($to)->
       setFrom($from)->
       //setFromName("")->
       setSubject("【xoBlosセミナーへのお申込みを受信しました。】" )->
...
// 正常終了時にthanks.htmlへリダイレクト
header('Location: /xoblos/form/seminar_form/thanks.html');
exit();