...
$email->addTo($emailAdd)->
       ...
       setHtml(" $name 様<br><br>この度は、弊社メールマガジン「IHSお役立ちメール」へご登録くださり<br>誠にありがとうございます。<br>登録解除をご希望の際は、web@iimhs.co.jp までご連絡頂けますよう<br>よろしくお願い申し上げます。<br><br>　本メールは、IIMヒューマン・ソリューションのメールマガジンへ <br> ご登録いただいた方へ送信しております。 <br> お心当たりのない方は、お手数ですが、web@iimhs.co.jpまでご連絡ください。<br><br> ※このメールは自動送信です。 ")->
       addCategory('contact');
